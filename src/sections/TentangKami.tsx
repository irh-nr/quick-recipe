...
export function TentangKami() {
  return (
    <div className="py-10 px-4">
        <h1 className="text-center typography-h1 p-10">Tentang Kami</h1>
            ...
            <div className="flex flex-col max-w-md justify-between">
                <div>
                    ...
                    <p className="typography-p text-center md:text-left">
                        Solusi resep simpel untuk hidup yang serba cepat.
                        Quick Recipe hadir untuk kamu yang ingin masak praktis setiap hari—dengan bahan sederhana, 
                        langkah singkat, dan hasil yang memuaskan. Cocok untuk siapa saja, di mana saja.                
                    </p>
                </div>
            </div>
